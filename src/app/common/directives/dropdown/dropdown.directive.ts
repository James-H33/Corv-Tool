...
export class DropdownDirective {
  templateRef = input<TemplateRef<unknown> | null>(null, { alias: 'ctDropdownTemplate' });
  dropdownTriggerType = input<'click' | 'contextmenu'>('click', { alias: 'ctDropdownTriggerType' });

  opened = output<ElementRef>({ alias: 'ctDropdownOpened' });
  closed = output<ElementRef>({ alias: 'ctDropdownClosed' });
